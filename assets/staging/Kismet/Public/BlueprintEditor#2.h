...
protected:
	...
	**/
	...
	// Added here for now..
	void ConvertSelectedComponentsToISMs(TArray<TSharedPtr<class FSCSEditorTreeNode>> SelectedNodes);
	...
	/** Called when ConvertToISMs is clicked */
	void ConvertToISM_OnClicked();
