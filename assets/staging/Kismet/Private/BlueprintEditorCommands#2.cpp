...
void FBlueprintEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND( ConvertSelectedToISM, "Convert to ISMs", "Convert all SELECTED static mesh component to ISMs", EUserInterfaceActionType::Button, FInputChord() );
...
void FSCSEditorViewportCommands::RegisterCommands()
{
	...
	UI_COMMAND(RearrangeComponentLocation, "Rearrange Actor Location", "Rearrange the location of Current Selected Actors.", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Alt, EKeys::W));
}
