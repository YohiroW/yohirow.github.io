...
function initShaders() {
    shaderPrograms = [
        createShader("shader-vs", "shader-fs0"),    // White
        createShader("shader-vs", "shader-fs1-1"),  // Position
        createShader("shader-vs", "shader-fs1-2"),  // Normal
        createShader("shader-vs", "shader-fs1-3"),  // Lighting dir
        createShader("shader-vs", "shader-fs2"),    // Diffuse
        createShader("shader-vs", "shader-fs3-1"),  // Phong
        createShader("shader-vs", "shader-fs3-2"),  // Blinn-Phong
        createShader("shader-vs", "shader-fs4"),    // Microfacet
    ];
    currentProgram = shaderPrograms[6];
